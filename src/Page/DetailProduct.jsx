          ...
          <div>
            <div>
              ...
              <ul>
                ...
                <li>
                  2. Akomodasi: Menginap di hotel bintang 3 atau setara selama 6
                  malam.
                </li>
                <li>
                ...
                <li>
                  5. Tiket Masuk: Biaya masuk ke destinasi wisata yang tercantum
                  dalam itinerary.
                </li>
                <li>
              ...
              <ul>
                <li>
                &#8226; Hari 1: Keberangkatan dari Jakarta ke Singapura, check-in
                  hotel, acara bebas.
                </li>
                <li>
                &#8226;  Hari 2: City tour mengunjungi Merlion Park, Gardens by the
                  Bay, Marina Bay Sands.
                </li>
                <li>&#8226; Hari 3: Universal Studios Singapore seharian penuh.</li>
                <li>
                &#8226; Hari 4: Wisata belanja di Orchard Road, kunjungan ke Chinatown
                  dan Little India.
                </li>
                <li>
                &#8226; Hari 5: Sentosa Island, termasuk S.E.A Aquarium dan Wings of
                  Time.
                </li>
                <li>
                &#8226; Hari 6: Wisata kuliner lokal, kunjungan ke Singapore Zoo atau
                  River Safari.
                </li>
                <li>
                &#8226; Hari 7: Waktu bebas hingga check-out, perjalanan kembali ke
                  Jakarta.
                </li>
              </ul>
              ...
              <ul>
                <li>
                &#8226; <span className="font-bold">DP (Down Payment): Rp 2.000.000 </span> per orang saat pemesanan,
                  non-refundable.
                </li>
                <li>
                &#8226; Pelunasan: Harus dilakukan paling lambat 14 hari sebelum
                  keberangkatan.
                </li>
                <li>
                &#8226;  Pembatalan: DP hangus jika pembatalan dilakukan setelah
                  pembayaran DP, pengembalian sebagian biaya sesuai ketentuan
                  jika pembatalan dilakukan setelah pelunasan.
                </li>
                <li>
                &#8226;  Dokumen: Paspor dengan masa berlaku minimal 6 bulan dari
                  tanggal keberangkatan, visa jika diperlukan.
                </li>
                <li>
                &#8226; Perubahan Jadwal: Jadwal dapat berubah sesuai kondisi setempat
