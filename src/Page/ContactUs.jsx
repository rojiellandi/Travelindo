  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute top-1/2 -translate-y-24 w-full max-w-6xl p-6 mx-auto flex space-x-6 ml-24">
          ...
          <form className="space-y-4">
            <div>
              <textarea
                ...
                className="mt-1 block w-full rounded-md bg-white bg-opacity-30 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              />
            </div>
            <div>
              <textarea
            ...
            <div>
              <textarea
                ...
                className="mt-1 block w-full h-52 rounded-md bg-white bg-opacity-30 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              />
            </div>
        ...
        {/* Main Office Details */}
        <div className="w-1/2 bg-white bg-opacity-30 rounded-lg shadow-lg p-6">
